# Copied from https://github.com/microsoft/BitNet (utils/convert-helper-bitnet.py)
# Reference only - not run in this project (depends on convert-ms-to-gguf-bitnet.py and llama-quantize).
